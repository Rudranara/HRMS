...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['ids'])) {
    ...
    if (!empty($ids)) {
        ...
        $query = "SELECT selfie_in, selfie_out FROM break_attendance WHERE id IN ($placeholders)";
        ...
        $delete_query = "DELETE FROM break_attendance WHERE id IN ($placeholders)";
        ...
        if ($delete_stmt->execute()) {
            ...
            echo "Selected break records and associated selfies deleted successfully!";
