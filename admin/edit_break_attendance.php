...
if (isset($_GET['id']) && !empty($_GET['id'])) {
    ...
    if ($result->num_rows > 0) {
        ...
        echo "break record not found.";
        exit;
    }
} else {
    echo "Invalid break ID.";
    exit;
}
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($update_stmt->execute()) {
        echo "<script>alert('Break record updated successfully!'); window.location.href = 'manage_break_attendance';</script>";
    } else {
...
.edit-break-shell,
.edit-break-modal .modal-content {
...
.edit-break-field .form-control,
.edit-break-field .form-select {
    min-height: 46px;
...
.edit-break-field .form-control:focus,
.edit-break-field .form-select:focus {
    border-color: #9aa8bc;
    background: #ffffff;
    box-shadow: 0 0 0 0.2rem rgba(148, 163, 184, 0.16);
}

.edit-break-field .form-control[disabled] {
    background: #f4f7fb;
    color: #475569;
    opacity: 1;
}

.edit-break-capture-btn,
.edit-break-submit-btn,
.edit-break-modal .btn-primary,
.edit-break-modal .btn-secondary {
    display: inline-flex;
    align-items: center;
...
.edit-break-submit-row {
    margin-top: 0.35rem;
}

.edit-break-modal .modal-dialog {
    max-width: 860px;
}
...
.edit-break-modal .modal-header,
.edit-break-modal .modal-footer {
    padding: 1.15rem 1.35rem;
    border-color: #e9eef5;
}

.edit-break-modal .modal-body {
    padding: 1.25rem 1.35rem 1.35rem;
}

.edit-break-modal .modal-title {
    color: #0f172a;
    font-size: 1.15rem;
    font-weight: 800;
...
<div class="container-fluid edit-break-page">
    <div class="row">
        <div class="col-12">
            <div class="card mb-4 edit-break-shell">
                <div class="card-body">
                    <h5 class="edit-break-title">Edit Break Record</h5>
                    <form method="POST" class="edit-break-form">
                        <div class="row">
                            <div class="col-6 edit-break-field">
                                <label for="employee_name" class="form-label">Employee Name</label>
                                <input type="text" class="form-control" id="employee_name" value="<?= $attendance['employee_name'] ?>" disabled>
                            </div>
                            <div class="col-6 edit-break-field">
                                <label for="punch_in_time" class="form-label">Start Break Time</label>
                            ...
                            <div class="col-6 edit-break-field">
                                <label for="punch_out_time" class="form-label">End Break Time</label>
                            ...
                            <div class="col-6 edit-break-field">
                                ...
                                <button type="button" class="btn btn-primary w-100 edit-break-capture-btn" data-bs-toggle="modal" data-bs-target="#selfieInModal">Take Selfie In</button>
                                <input type="hidden" id="selfie_in" name="selfie_in" value="<?= $attendance['selfie_in'] ?>">
                                <?php if (!empty($attendance['selfie_in'])): ?>
                                    <div class="edit-break-preview">
                            ...
                            <div class="col-6 edit-break-field">
                                ...
                                <button type="button" class="btn btn-primary w-100 edit-break-capture-btn" data-bs-toggle="modal" data-bs-target="#selfieOutModal">Take Selfie Out</button>
                            ...
                            <div class="col-6 edit-break-field">
                                <label for="working_hours" class="form-label">Break Hours</label>
                            ...
                            <div class="col-6 mt-4 edit-break-submit-row">
                                <button type="submit" class="btn btn-primary edit-break-submit-btn">Update Break</button>
                            </div>
                        </div>
                    </form>
                </div>
...
<!-- Selfie In Modal -->
<div class="modal fade edit-break-modal" id="selfieInModal" tabindex="-1" aria-labelledby="selfieInModalLabel" aria-hidden="true">
...
<!-- Selfie Out Modal -->
<div class="modal fade edit-break-modal" id="selfieOutModal" tabindex="-1" aria-labelledby="selfieOutModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <div class="modal-header">
