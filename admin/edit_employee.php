...
if (!empty($_POST['password'])) {
    ...
    $stmt = $conn->prepare("UPDATE employees SET 
        employee_id = ?, name = ?, phone = ?, email = ?, esic = ?, address = ?, dob = ?, anniversary = ?, designation = ?, role = ?, father_name = ?, manager = ?, salary_type = ?, 
    ...
    $stmt->bind_param(
        "ssssssssssssssssssssssssssssssssiiiiidddddddddddddddddddddddddssss",
         $employeeid, $name, $phone, $email, $esic, $address, $dob, $anniversary, $designation, $role, $father_name, $manager, $salary_type, $office,
...
.edit-employee-card-header {
    padding: 1.2rem 1.45rem 0.25rem !important;
    border: 0;
    background: transparent;
}

.edit-employee-card-body {
...
.edit-employee-form h5,
.edit-employee-form h6 {
    width: 100%;
    color: #111827;
    font-weight: 800;
}
...
.edit-employee-form label:not(.form-check-label) {
    color: #6b7280;
    font-size: 0.76rem;
    font-weight: 700;
...
.edit-employee-form select.form-control {
    min-height: 48px;
    border-radius: 14px;
...
.edit-employee-form textarea.form-control {
    min-height: 110px;
    resize: vertical;
}

.edit-employee-form input[type="file"].form-control {
    min-height: 48px;
    padding-top: 0.62rem;
...
.edit-employee-form .form-select:focus,
.edit-employee-form select.form-control:focus {
    border-color: #1e3a5f;
    box-shadow: 0 0 0 0.2rem rgba(30, 58, 95, 0.12);
}

.edit-employee-form .text-danger,
.edit-employee-form small {
    font-size: 0.78rem;
}

.edit-employee-form .col-md-2,
.edit-employee-form .col-md-4,
.edit-employee-form .col-md-6,
.edit-employee-form .col-md-12 {
    margin-top: 1rem !important;
}

.edit-employee-topbar {
    display: flex;
    align-items: center;
...
.edit-employee-topbar-title {
    flex: 1 1 auto;
}

.edit-employee-topbar-action {
    margin-left: auto;
    text-align: right;
}

.edit-employee-btn-primary,
.edit-employee-shell .btn.btn-primary {
...
.edit-employee-btn-primary:hover,
.edit-employee-shell .btn.btn-primary:hover {
    background: linear-gradient(135deg, #101010 0%, #242424 100%) !important;
    color: #fff !important;
}

.edit-employee-btn-secondary {
...
.edit-employee-btn-secondary:hover {
    background: #10263c !important;
    border-color: #10263c !important;
    color: #fff !important;
}

.edit-employee-topbar .btn,
.edit-employee-submit .btn,
.edit-employee-toggle-grid .btn {
    min-height: 42px;
...
.edit-employee-toggle-grid {
    margin-top: 0.35rem;
    row-gap: 1rem;
}

.edit-employee-toggle-grid > div {
    display: flex;
...
.edit-employee-toggle-grid .form-check.form-switch {
    margin: 0;
    padding-left: 0;
    display: flex;
    align-items: center;
...
.edit-employee-toggle-grid .form-check-label {
    margin: 0;
    color: #475569;
    font-size: 0.78rem;
    font-weight: 700;
...
.edit-employee-toggle-grid .form-check-input {
    width: 2.6rem;
    height: 1.35rem;
    margin: 0;
    float: none;
...
.edit-employee-toggle-grid .form-check-input:checked {
...
.edit-employee-breakdown-card {
    align-items: center;
    justify-content: center !important;
}

.edit-employee-breakdown-card .form-check {
    width: 100%;
    justify-content: center !important;
}

.edit-employee-breakdown-btn {
...
@media (min-width: 768px) {
    ...
    .edit-employee-toggle-grid > .col-md-2 {
        flex: 1 1 0;
    }

    .edit-employee-toggle-grid > .edit-employee-breakdown-card {
        flex: 0 0 200px;
    }
}
...
<div class="container-fluid py-4 edit-employee-shell">
    <div class="col-md-12 mb-lg-0 mb-4">
        <div class="card mt-4 edit-employee-card">
            <div class="card-header pb-0 p-3 edit-employee-card-header">
                <div class="edit-employee-topbar">
                    <div class="edit-employee-topbar-title d-flex align-items-center">
                        <h6 class="mb-0">Edit Employee Details</h6>
                    </div>
                    <div class="edit-employee-topbar-action">
                        <a href="manage_employee" class="btn edit-employee-btn-primary mb-0">Back to Employee List</a>
                    </div>
                </div>
            </div>
            <div class="card-body p-2 edit-employee-card-body">
                <form method="POST" enctype="multipart/form-data" id="employeeForm" class="edit-employee-form">
                    <div class="row edit-employee-form-grid">
                          <div class="col-md-6 mt-4">
                            <label for="employee_id" class="form-label">Employee ID</label>
                            <input class="form-control" type="text" name="employee_id" id="employee_id" value="<?= htmlspecialchars($employee['employee_id']) ?>" oninput="this.value = this.value.toUpperCase();" onblur="checkEmployeeID(this.value)">
...
<div class="row mt-3 edit-employee-toggle-grid">
    <div class="col-md-2">
        ...
        <div class="form-check form-switch">
            <input class="form-check-input toggle-switch" type="checkbox" id="toggle_epf" name="toggle_epf" value="1"
                <?= !empty($employee['include_epf']) ? 'checked' : '' ?>>
            <label class="form-check-label">Yes</label>
        </div>
    </div>

    <div class="col-md-2 <?= !empty($employee['include_epf']) ? '' : 'd-none' ?>" id="pf_ceiling_wrapper">
        ...
        <div class="form-check form-switch">
            <input class="form-check-input toggle-switch" type="checkbox" id="toggle_pf_ceiling" name="toggle_pf_ceiling" value="1"
                <?= !empty($employee['include_pf_ceiling']) ? 'checked' : '' ?>>
            <label class="form-check-label">Yes</label>
        </div>
    </div>
    ...
    <div class="col-md-2">
        ...
        <div class="form-check form-switch">
            <input class="form-check-input toggle-switch" type="checkbox" id="toggle_esic" name="toggle_esic" value="1"
                <?= !empty($employee['include_esic']) ? 'checked' : '' ?>>
            <label class="form-check-label">Yes</label>
        </div>
    </div>
    ...
    <div class="col-md-2">
        ...
        <div class="form-check form-switch">
            <input class="form-check-input toggle-switch" type="checkbox" id="toggle_gratuity" name="toggle_gratuity" value="1"
                <?= !empty($employee['include_gratuity']) ? 'checked' : '' ?>>
            <label class="form-check-label">Yes</label>
        </div>
    </div>
    ...
    <div class="col-md-2">
        ...
        <div class="form-check form-switch">
            <input class="form-check-input toggle-switch" type="checkbox" id="toggle_pt" name="toggle_pt" value="1"
                <?= !empty($employee['include_pt']) ? 'checked' : '' ?>>
            <label class="form-check-label">Yes</label>
        </div>
    </div>

    <div class="col-md-2 edit-employee-breakdown-card">
      
        <div class="form-check form-switch">
        <button type="button" class="btn edit-employee-btn-secondary edit-employee-breakdown-btn" data-bs-toggle="modal" data-bs-target="#salaryBreakdownModal">Salary Breakdown
</button>
        </div>
    </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="decimal" name="basic" id="basic" class="form-control calculate" value="<?php echo $employee['basic']; ?>" required>
                        </div>
                        <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="number" step="0.01" name="hra" id="hra" class="form-control calculate" value="<?php echo $employee['hra']; ?>">
                        </div>
                        <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="decimal" name="gmc" id="gmc" class="form-control calculate" value="<?php echo $employee['gmc'] ?? 0; ?>">
                        </div>
                        <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="decimal" name="esic_employee" id="esic_employee" class="form-control calculate" value="<?php echo $employee['esic_employee'] ?? 0; ?>">
                        </div>
                        <div class="col-md-4">
                            <label for="professional_tax">Professional Tax (PT)</label>
                            <input type="decimal" name="professional_tax" id="professional_tax" class="form-control" value="<?php echo $employee['professional_tax']; ?>">
                        </div>
            ...
            <select class="form-control" name="status" id="status" required>
                ...
                <option value="x_employee" <?= ($employee['status'] == 'x_employee') ? 'selected' : '' ?>>X Employee</option>
                    ...
                    <div class="text-center mt-4 edit-employee-submit">
                        <button class="btn edit-employee-btn-primary" type="submit">Update Employee</button>
                    </div>
                </form>
            </div>
        </div>
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    function syncPfCeilingVisibility() {
        if (!epfToggle || !pfCeilingToggle || !pfCeilingWrapper) {
            return;
        }
